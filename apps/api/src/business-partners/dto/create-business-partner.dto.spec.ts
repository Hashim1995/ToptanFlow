...
describe('CreateBusinessPartnerDto validation', () => {
  ...
  it('CreateBusinessPartnerDto does not declare currency fields', () => {
    expect(new CreateBusinessPartnerDto()).not.toHaveProperty(
      'defaultCurrencyId',
    );
  });
...
describe('ListBusinessPartnersQueryDto validation', () => {
  ...
  it('rejects invalid boolean strings, pagination, and sorting', async () => {
    await expect(
  ...
  it('does not accept defaultCurrencyId filter', () => {
    expect(new ListBusinessPartnersQueryDto()).not.toHaveProperty(
      'defaultCurrencyId',
    );
  });
});
