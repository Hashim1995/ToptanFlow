...
function SummaryStat(props: {
  ...
  return (
    <Card
      className={`cash-report-stat${props.danger ? " is-danger" : ""}`}
      size="small"
    >
      <Text type="secondary">{props.label}</Text>
      <div>
        <Text strong type={props.danger ? "danger" : undefined}>
...
export function CashReportsPage() {
  ...
  return (
    <div className="ui-page ui-report-page cash-reports-page">
      ...
      <Card className="cash-report-filter-card" size="small">
        <FilterBar
          onSearch={() => {
      ...
      <Title className="cash-report-section-title" level={5}>
      ...
      {(summary.data?.expensesByCategory.length ?? 0) > 0 ? (
        <Card
          className="cash-report-breakdown-card"
          size="small"
      ...
      <Title className="cash-report-section-title" level={5}>
        {CASH_LABELS.statementTitle}
      </Title>

      {!accountId ? (
        <Card className="cash-report-empty-card">
        ...
        <>
          ...
          <Card className="cash-statement-card" size="small">
            {isMobile ? (
