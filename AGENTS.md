...
Approved technology choices are recorded as Accepted ADRs and must be followed by every implementation agent: [`ADR-006`](docs/decisions/ADR-006-react-typescript-frontend.md) (React/TypeScript frontend), [`ADR-007`](docs/decisions/ADR-007-nestjs-typescript-backend.md) (NestJS/TypeScript backend), [`ADR-008`](docs/decisions/ADR-008-postgresql-primary-database.md) (PostgreSQL), [`ADR-009`](docs/decisions/ADR-009-ant-design-ui-library.md) (Ant Design), [`ADR-010`](docs/decisions/ADR-010-axios-http-client.md) (Axios), [`ADR-011`](docs/decisions/ADR-011-redux-toolkit-client-state.md) (Redux Toolkit), [`ADR-012`](docs/decisions/ADR-012-yarn-workspaces.md) (Yarn/Yarn Workspaces), [`ADR-013`](docs/decisions/ADR-013-vite-build-system.md) (Vite), [`ADR-014`](docs/decisions/ADR-014-prisma-orm.md) (Prisma ORM), [`ADR-015`](docs/decisions/ADR-015-rest-openapi.md) (REST/OpenAPI), [`ADR-016`](docs/decisions/ADR-016-tanstack-query.md) (TanStack Query), [`ADR-017`](docs/decisions/ADR-017-react-hook-form-zod.md) (React Hook Form/Zod), [`ADR-018`](docs/decisions/ADR-018-testing-strategy.md) (Vitest/Jest/Supertest), [`ADR-019`](docs/decisions/ADR-019-eslint-prettier.md) (ESLint/Prettier), [`ADR-020`](docs/decisions/ADR-020-uuid-identifiers.md) (UUID identifiers), [`ADR-021`](docs/decisions/ADR-021-prisma-migrate.md) (Prisma Migrate), [`ADR-023`](docs/decisions/ADR-023-postgresql-decimal-precision.md) (PostgreSQL decimal precision), [`ADR-024`](docs/decisions/ADR-024-automatic-business-code-generation.md) (automatic Product/BusinessPartner business codes), [`ADR-025`](docs/decisions/ADR-025-jwt-auth-flat-users-v1.md) (JWT auth, flat equal users v1), [`ADR-028`](docs/decisions/ADR-028-sale-purchase-cash-separation.md) (Sale/Purchase must not directly mutate cash), [`ADR-029`](docs/decisions/ADR-029-single-product-quantity-no-warehouse.md) (single product quantity; no separate Warehouse/Stock module), [`ADR-030`](docs/decisions/ADR-030-signed-business-partner-debt-balance.md) (one signed Business Partner debt balance), [`ADR-031`](docs/decisions/ADR-031-currency-reserved-for-future-cash.md) (AZN-only now; Currency reserved for future Cash — not current master data), [`ADR-032`](docs/decisions/ADR-032-multiple-cash-accounts.md) (multiple Cash Accounts in one Cash domain), [`ADR-033`](docs/decisions/ADR-033-cash-balance-via-transactions.md) (cash balance only via transactions), [`ADR-034`](docs/decisions/ADR-034-cash-transfer-atomic.md) (atomic internal Cash Transfer), [`ADR-035`](docs/decisions/ADR-035-immutable-cash-reversal.md) (immutable cash + reversal cancel), [`ADR-036`](docs/decisions/ADR-036-cash-lifecycle-no-draft.md) (ordinary cash without Draft), [`ADR-037`](docs/decisions/ADR-037-controlled-negative-cash.md) (controlled negative cash with reason), [`ADR-038`](docs/decisions/ADR-038-cash-primary-operations-model.md) (Cash In / Cash Out / Expense / Transfer primary model). [`ADR-026`](docs/decisions/ADR-026-initial-warehouses-v1.md) and warehouse-scoped wording in [`ADR-027`](docs/decisions/ADR-027-allow-negative-stock-v1.md) are superseded by ADR-029. High-level architecture and logical repository structure are described in [`docs/technical/system-architecture.md`](docs/technical/system-architecture.md) and [`docs/technical/repository-structure.md`](docs/technical/repository-structure.md), which these ADRs do not duplicate.
